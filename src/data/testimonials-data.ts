export default [
  {
    ...
    explanation:
      'I would like to express my sincere appreciation to the exceptional tutors at Datafied Academy for imparting invaluable knowledge in the field of Data Analytics. The learning experience has been enlightening for both myself and my fellow learners, and your efforts are truly commendable.',
    rating: 4.5
  },
  {
    username: 'Steve',
    ...
    explanation:
      "The journey in the field of Data Analytics has been truly remarkable, starting from a complete novice to delving deep into Excel and Power BI, performing calculations, and crafting impactful visuals and dashboards. Datafied Academy has proven to be an outstanding institution thus far, and I eagerly anticipate further knowledge acquisition and growth. Applauding the Academy's excellence!",
    rating: 4.5
  },
  {
    username: 'Amanda',
  ...
  },
  {
    ...
    explanation:
      'My journey at Datafied Academy has been extremely fulfilling as I immersed myself in the realm of Excel and Power BI. Right from the start, the courses have offered a comprehensive and well-organized approach to mastering these influential data analysis tools. The interactive nature of the courses, including quizzes and assignments, has allowed me to put my knowledge into practice and reinforce my understanding. I would like to express my utmost appreciation to my instructors for their humility and wholehearted dedication. It is truly admirable. To my fellow Titans, I am honored to be associated with such brilliant minds. I eagerly anticipate collaborating and working together, tackling complex datasets, and uncovering valuable insights.',
    rating: 5
  },
  {
    username: 'Pelumi',
    title:
      'Persistence Pays Off: Data Analytics Success on the Fifth Attempt with Datafied Academy',
    explanation:
  ...
  },
  {
    username: 'Koketso',
    title:
      'Exceptional Data Analytics Journey: Excel, Power BI, and Beyond at Datafied Academy',
    explanation:
      "At Datafied Academy, my data analytics journey has been exceptional. I've learned advanced Excel techniques, empowering me to manipulate and analyze data effectively. Power BI introduced me to data visualization, creating interactive dashboards for insightful presentations. Now, I'm excited to dive into SQL and master database management. The practical approach, support from instructors, and collaboration with peers have made learning enjoyable. Beyond technical skills, the emphasis on critical thinking and problem-solving prepares me for real-world data challenges. I'm confident that these skills will pave the way for a successful career in data analytics.",
    rating: 5
  },
  {
    username: 'Lydia',
    title:
      'Transformative Data Analytics Journey: From Zero to Proficiency with Datafied Tutors',
    explanation:
