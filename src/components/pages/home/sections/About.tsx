  ...
  return (
    <Section title="About Datafied">
      <p className="tw-parag tw-text-center tabLand:tw-text-left">
        ...
        knowledge and skills to unlock their full potential and make a formidable impact
        in their world. By fostering a continuous learning and innovation culture, we
