...
export const isStrongPassword: Validator<string> = function (
...
// export const isValidWebUrl: Validator<string> = async function (errMsg = 'Not a valid url') {
//   const sendReq = async () => {
//     const res = await fetch(this.userInput);
//   }
